...
print (f'Скорость {car.speed}, Цвет: {car.color}, Название: {car.name}, Is_police: {car.is_polise}')
car.go()
car.stop()
car.turn('налево')
...
print (town_car.show_speed(town_car.speed))
...
print (work_car.show_speed(work_car.speed))
